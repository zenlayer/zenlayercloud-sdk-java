...
public class TrafficClient extends AbstractClient {
    ...
    public TrafficClient(TokenCredential credential, Config config) {
        super(credential, config,
            config.getEndpoint() != null ? config.getEndpoint() : ENDPOINT,
            VERSION, PATH);
    }
    ...
    public DescribeBandwidthClusterTrafficResponse describeBandwidthClusterTraffic(DescribeBandwidthClusterTrafficRequest request) {
         ...
         * 修改带宽包的保底带宽。
         */
    public UpdateBandwidthClusterCommitBandwidthResponse updateBandwidthClusterCommitBandwidth(UpdateBandwidthClusterCommitBandwidthRequest request) {
        Map<String, ?> rsp = super.callApi(
            request,
         ...
         */
    public ModifyBandwidthClusterAttributeResponse modifyBandwidthClusterAttribute(ModifyBandwidthClusterAttributeRequest request) {
        Map<String, ?> rsp = super.callApi(
            request,
            "ModifyBandwidthClusterAttribute",
            new RuntimeOptions()
        );
        return TeaModel.toModel(rsp, new ModifyBandwidthClusterAttributeResponse());
    }
    ...
    public DescribeBandwidthClusterResourcesResponse describeBandwidthClusterResources(DescribeBandwidthClusterResourcesRequest request) {
         ...
         * 查询共享带宽包的用量信息。
         */
    public DescribeBandwidthClusterUsageResponse describeBandwidthClusterUsage(DescribeBandwidthClusterUsageRequest request) {
        Map<String, ?> rsp = super.callApi(
            request,
            "DescribeBandwidthClusterUsage",
            new RuntimeOptions()
        );
        return TeaModel.toModel(rsp, new DescribeBandwidthClusterUsageResponse());
    }
