 ...
 */
public class AllocateDdosIpAddressesRequest extends TeaModel {
    ...
    /**
     * 预付费模式，即包年包月相关参数设置。通过该参数可以指定包年包月DDOS IP的购买时长等属性
     * 若指定DDOS IP的付费模式为预付费则该参数必传
     */
    public ChargePrePaid ddosIpChargePrepaid;
