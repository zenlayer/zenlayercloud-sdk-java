...
public class DescribeManagedInstanceTrafficResponse extends TeaModel {
    ...
    public List<InstanceTrafficData> getDataList() {
        return this.dataList;
    }

    public void setDataList(List<InstanceTrafficData> dataList) {
